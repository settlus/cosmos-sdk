...
func TestSlashRedelegation(t *testing.T) {
	...
	createValMsg1, _ := stakingtypes.NewMsgCreateValidator(
		evilValAddr, evilValPubKey, testCoins[0], stakingtypes.Description{Details: "test"}, stakingtypes.NewCommissionRates(math.LegacyNewDecWithPrec(5, 1), math.LegacyNewDecWithPrec(5, 1), math.LegacyNewDec(0)), math.OneInt(), math.ZeroInt(), sdk.ZeroDec())
	...
	createValMsg2, _ := stakingtypes.NewMsgCreateValidator(
		goodValAddr, goodValPubKey, testCoins[0], stakingtypes.Description{Details: "test"}, stakingtypes.NewCommissionRates(math.LegacyNewDecWithPrec(5, 1), math.LegacyNewDecWithPrec(5, 1), math.LegacyNewDec(0)), math.OneInt(), math.ZeroInt(), sdk.ZeroDec())
