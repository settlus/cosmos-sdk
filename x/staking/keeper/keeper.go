...
func NewKeeper(
	cdc codec.BinaryCodec, key storetypes.StoreKey, ak types.AccountKeeper, bk types.BankKeeper, dk types.DistributionKeeper,
...
// TODO: implement in keeper when version is updated
