...
import (
	...
	_ "cosmossdk.io/api/tendermint/abci"
...
func init() {
	file_cosmos_staking_v046_staking_proto_init()
	md_HistoricalInfo = File_cosmos_staking_v046_staking_proto.Messages().ByName("HistoricalInfo")
...
func (x *HistoricalInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v046_staking_proto_msgTypes[0]
...
func (x *fastReflection_HistoricalInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v046.HistoricalInfo.header":
		return x.Header != nil
	case "cosmos.staking.v046.HistoricalInfo.valset":
		return len(x.Valset) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.HistoricalInfo"))
		}
		panic(fmt.Errorf("message cosmos.staking.v046.HistoricalInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_HistoricalInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v046.HistoricalInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_HistoricalInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v046.HistoricalInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_staking_v046_staking_proto_init()
	md_CommissionRates = File_cosmos_staking_v046_staking_proto.Messages().ByName("CommissionRates")
...
func (x *CommissionRates) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v046_staking_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CommissionRates) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v046.CommissionRates.rate":
		return x.Rate != ""
	case "cosmos.staking.v046.CommissionRates.max_rate":
		return x.MaxRate != ""
	case "cosmos.staking.v046.CommissionRates.max_change_rate":
		return x.MaxChangeRate != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.CommissionRates"))
		}
		panic(fmt.Errorf("message cosmos.staking.v046.CommissionRates does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v046.CommissionRates does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommissionRates) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v046.CommissionRates.rate":
		panic(fmt.Errorf("field rate of message cosmos.staking.v046.CommissionRates is not mutable"))
	case "cosmos.staking.v046.CommissionRates.max_rate":
		panic(fmt.Errorf("field max_rate of message cosmos.staking.v046.CommissionRates is not mutable"))
	case "cosmos.staking.v046.CommissionRates.max_change_rate":
		panic(fmt.Errorf("field max_change_rate of message cosmos.staking.v046.CommissionRates is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.CommissionRates"))
		}
...
func (x *fastReflection_CommissionRates) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v046.CommissionRates", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_staking_v046_staking_proto_init()
	md_Commission = File_cosmos_staking_v046_staking_proto.Messages().ByName("Commission")
...
func (x *Commission) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v046_staking_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Commission) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v046.Commission.commission_rates":
		return x.CommissionRates != nil
	case "cosmos.staking.v046.Commission.update_time":
		return x.UpdateTime != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.Commission"))
		}
		panic(fmt.Errorf("message cosmos.staking.v046.Commission does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Commission) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v046.Commission does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Commission) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v046.Commission", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_cosmos_staking_v046_staking_proto_init()
	md_Description = File_cosmos_staking_v046_staking_proto.Messages().ByName("Description")
...
func (x *Description) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v046_staking_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Description) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v046.Description.moniker":
		return x.Moniker != ""
	case "cosmos.staking.v046.Description.identity":
		return x.Identity != ""
	case "cosmos.staking.v046.Description.website":
		return x.Website != ""
	case "cosmos.staking.v046.Description.security_contact":
		return x.SecurityContact != ""
	case "cosmos.staking.v046.Description.details":
		return x.Details != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.Description"))
		}
		panic(fmt.Errorf("message cosmos.staking.v046.Description does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Description) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v046.Description does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Description) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.staking.v046.Description.moniker":
		panic(fmt.Errorf("field moniker of message cosmos.staking.v046.Description is not mutable"))
	case "cosmos.staking.v046.Description.identity":
		panic(fmt.Errorf("field identity of message cosmos.staking.v046.Description is not mutable"))
	case "cosmos.staking.v046.Description.website":
		panic(fmt.Errorf("field website of message cosmos.staking.v046.Description is not mutable"))
	case "cosmos.staking.v046.Description.security_contact":
		panic(fmt.Errorf("field security_contact of message cosmos.staking.v046.Description is not mutable"))
	case "cosmos.staking.v046.Description.details":
		panic(fmt.Errorf("field details of message cosmos.staking.v046.Description is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.Description"))
		}
...
func (x *fastReflection_Description) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v046.Description", d.FullName()))
	}
	panic("unreachable")
}
...
var (
	...
	fd_Validator_max_delegation      protoreflect.FieldDescriptor
	fd_Validator_probono             protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_staking_v046_staking_proto_init()
	md_Validator = File_cosmos_staking_v046_staking_proto.Messages().ByName("Validator")
	...
	fd_Validator_max_delegation = md_Validator.Fields().ByName("max_delegation")
	fd_Validator_probono = md_Validator.Fields().ByName("probono")
}
...
func (x *Validator) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_staking_v046_staking_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Validator) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.MaxDelegation != "" {
		...
		if !f(fd_Validator_max_delegation, value) {
			return
		}
	}
	if x.Probono != false {
		value := protoreflect.ValueOfBool(x.Probono)
		if !f(fd_Validator_probono, value) {
			return
		}
	}
}
...
func (x *fastReflection_Validator) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.staking.v046.Validator.operator_address":
		return x.OperatorAddress != ""
	case "cosmos.staking.v046.Validator.consensus_pubkey":
		return x.ConsensusPubkey != nil
	case "cosmos.staking.v046.Validator.jailed":
		return x.Jailed != false
	case "cosmos.staking.v046.Validator.status":
		return x.Status != 0
	case "cosmos.staking.v046.Validator.tokens":
		return x.Tokens != ""
	case "cosmos.staking.v046.Validator.delegator_shares":
		return x.DelegatorShares != ""
	case "cosmos.staking.v046.Validator.description":
		return x.Description != nil
	case "cosmos.staking.v046.Validator.unbonding_height":
		return x.UnbondingHeight != int64(0)
	case "cosmos.staking.v046.Validator.unbonding_time":
		return x.UnbondingTime != nil
	case "cosmos.staking.v046.Validator.commission":
		return x.Commission != nil
	case "cosmos.staking.v046.Validator.min_self_delegation":
		return x.MinSelfDelegation != ""
	case "cosmos.staking.v046.Validator.max_delegation":
		return x.MaxDelegation != ""
	case "cosmos.staking.v046.Validator.probono":
		return x.Probono != false
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.Validator"))
		}
		panic(fmt.Errorf("message cosmos.staking.v046.Validator does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Validator) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message cosmos.staking.v046.Validator does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Validator) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "cosmos.staking.v046.Validator.operator_address":
		panic(fmt.Errorf("field operator_address of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.jailed":
		panic(fmt.Errorf("field jailed of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.status":
		panic(fmt.Errorf("field status of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.tokens":
		panic(fmt.Errorf("field tokens of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.delegator_shares":
		panic(fmt.Errorf("field delegator_shares of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.unbonding_height":
		panic(fmt.Errorf("field unbonding_height of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.min_self_delegation":
		panic(fmt.Errorf("field min_self_delegation of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.max_delegation":
		panic(fmt.Errorf("field max_delegation of message cosmos.staking.v046.Validator is not mutable"))
	case "cosmos.staking.v046.Validator.probono":
		panic(fmt.Errorf("field probono of message cosmos.staking.v046.Validator is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.staking.v046.Validator"))
		}
...
func (x *fastReflection_Validator) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.staking.v046.Validator", d.FullName()))
	}
	panic("unreachable")
}
...
func (BondStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_cosmos_staking_v046_staking_proto_enumTypes[0].Descriptor()
}

func (BondStatus) Type() protoreflect.EnumType {
	return &file_cosmos_staking_v046_staking_proto_enumTypes[0]
}
...
func (BondStatus) EnumDescriptor() ([]byte, []int) {
	return file_cosmos_staking_v046_staking_proto_rawDescGZIP(), []int{0}
}
...
func (*CommissionRates) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v046_staking_proto_rawDescGZIP(), []int{1}
}
...
func (*Commission) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v046_staking_proto_rawDescGZIP(), []int{2}
}
...
func (*Description) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v046_staking_proto_rawDescGZIP(), []int{3}
}
...
func (*Validator) Descriptor() ([]byte, []int) {
	return file_cosmos_staking_v046_staking_proto_rawDescGZIP(), []int{4}
}
...
func (x *Validator) GetMaxDelegation() string {
	if x != nil {
		return x.MaxDelegation
	}
	return ""
...
func (x *Validator) GetProbono() bool {
	if x != nil {
		return x.Probono
	}
	return false
...
var File_cosmos_staking_v046_staking_proto protoreflect.FileDescriptor

var file_cosmos_staking_v046_staking_proto_rawDesc = []byte{
	0x0a, 0x21, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67,
	0x2f, 0x76, 0x30, 0x34, 0x36, 0x2f, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x12, 0x13, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x2e, 0x73, 0x74, 0x61, 0x6b,
	0x69, 0x6e, 0x67, 0x2e, 0x76, 0x30, 0x34, 0x36, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72,
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x19, 0x63, 0x6f, 0x73, 0x6d,
	...
	0x6e, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c, 0x74, 0x65, 0x6e, 0x64, 0x65, 0x72,
	...
	,
	...
	0x6f, 0x73, 0x2e, 0x44, 0x65, 0x63, 0x52, 0x04, 0x72, 0x61, 0x74, 0x65, 0x12, 0x57, 0x0a, 0x08,
	0x6d, 0x61, 0x78, 0x5f, 0x72, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x3c,
	...
	,
	...
	0x08, 0x98, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x01, 0x22, 0xce, 0x07, 0x0a, 0x09, 0x56, 0x61,
	...
	,
	...
	0x69, 0x6d, 0x65, 0x12, 0x4a, 0x0a, 0x0a, 0x63, 0x6f, 0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73,
	0x2e, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x30, 0x34, 0x36, 0x2e, 0x43, 0x6f,
	0x6d, 0x6d, 0x69, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x42, 0x09, 0xc8, 0xde, 0x1f, 0x00, 0xa8, 0xe7,
	...
	0x67, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x09, 0x42, 0x3c, 0xc8, 0xde,
	...
	,
	...
	0xa3, 0x1e, 0x00, 0x42, 0xc7, 0x01, 0x0a, 0x17, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x6f, 0x73, 0x6d,
	0x6f, 0x73, 0x2e, 0x73, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x2e, 0x76, 0x30, 0x34, 0x36, 0x42,
	0x0c, 0x53, 0x74, 0x61, 0x6b, 0x69, 0x6e, 0x67, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	...
	,
}

var (
	file_cosmos_staking_v046_staking_proto_rawDescOnce sync.Once
	file_cosmos_staking_v046_staking_proto_rawDescData = file_cosmos_staking_v046_staking_proto_rawDesc
)

func file_cosmos_staking_v046_staking_proto_rawDescGZIP() []byte {
	file_cosmos_staking_v046_staking_proto_rawDescOnce.Do(func() {
		file_cosmos_staking_v046_staking_proto_rawDescData = protoimpl.X.CompressGZIP(file_cosmos_staking_v046_staking_proto_rawDescData)
	})
	return file_cosmos_staking_v046_staking_proto_rawDescData
}

var file_cosmos_staking_v046_staking_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_cosmos_staking_v046_staking_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cosmos_staking_v046_staking_proto_goTypes = []interface{}{
	(BondStatus)(0),               // 0: cosmos.staking.v046.BondStatus
	(*HistoricalInfo)(nil),        // 1: cosmos.staking.v046.HistoricalInfo
	(*CommissionRates)(nil),       // 2: cosmos.staking.v046.CommissionRates
	(*Commission)(nil),            // 3: cosmos.staking.v046.Commission
	(*Description)(nil),           // 4: cosmos.staking.v046.Description
	(*Validator)(nil),             // 5: cosmos.staking.v046.Validator
	(*types.Header)(nil),          // 6: tendermint.types.Header
	(*timestamppb.Timestamp)(nil), // 7: google.protobuf.Timestamp
	(*anypb.Any)(nil),             // 8: google.protobuf.Any
}
var file_cosmos_staking_v046_staking_proto_depIdxs = []int32{
	6, // 0: cosmos.staking.v046.HistoricalInfo.header:type_name -> tendermint.types.Header
	5, // 1: cosmos.staking.v046.HistoricalInfo.valset:type_name -> cosmos.staking.v046.Validator
	2, // 2: cosmos.staking.v046.Commission.commission_rates:type_name -> cosmos.staking.v046.CommissionRates
	7, // 3: cosmos.staking.v046.Commission.update_time:type_name -> google.protobuf.Timestamp
	8, // 4: cosmos.staking.v046.Validator.consensus_pubkey:type_name -> google.protobuf.Any
	0, // 5: cosmos.staking.v046.Validator.status:type_name -> cosmos.staking.v046.BondStatus
	4, // 6: cosmos.staking.v046.Validator.description:type_name -> cosmos.staking.v046.Description
	7, // 7: cosmos.staking.v046.Validator.unbonding_time:type_name -> google.protobuf.Timestamp
	3, // 8: cosmos.staking.v046.Validator.commission:type_name -> cosmos.staking.v046.Commission
...
func init() { file_cosmos_staking_v046_staking_proto_init() }
func file_cosmos_staking_v046_staking_proto_init() {
	if File_cosmos_staking_v046_staking_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_cosmos_staking_v046_staking_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v046_staking_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v046_staking_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v046_staking_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cosmos_staking_v046_staking_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_cosmos_staking_v046_staking_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_cosmos_staking_v046_staking_proto_goTypes,
		DependencyIndexes: file_cosmos_staking_v046_staking_proto_depIdxs,
		EnumInfos:         file_cosmos_staking_v046_staking_proto_enumTypes,
		MessageInfos:      file_cosmos_staking_v046_staking_proto_msgTypes,
	}.Build()
	File_cosmos_staking_v046_staking_proto = out.File
	file_cosmos_staking_v046_staking_proto_rawDesc = nil
	file_cosmos_staking_v046_staking_proto_goTypes = nil
	file_cosmos_staking_v046_staking_proto_depIdxs = nil
}
